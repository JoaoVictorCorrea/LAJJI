 ...
 * @author jvcor
 */
@WebServlet(name = "SAlterarProduto", urlPatterns = {"/SAlterarProduto"})
public class SAlterarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            objP = new Produto();
            objP.setCodigo(Integer.valueOf(request.getParameter("txtCodigo")));
            ...
            if(objDAO.alterarProduto(objP))
                response.sendRedirect("logged/palteracao/alteracao.html");
