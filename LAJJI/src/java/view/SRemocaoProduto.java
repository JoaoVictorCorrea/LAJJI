 ...
 * @author jvcor
 */
@WebServlet(name = "SRemocaoProduto", urlPatterns = {"/SRemocaoProduto"})
public class SRemocaoProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<head>");
                ...
                out.println("<link rel='stylesheet' href='logged/premocao/remocao.css'>");
                out.println("<title>LAJJI | Remoção</title>");
            out.println("</head>");
            out.println("<body>");
                ...
                out.println("<div class='container'>");
                    out.println("<section class='image-top'>");
            ...
            for(int i = 0; i < lista.size(); i++)
            {
                ...
                out.println("<td>" + objP.getMarca() + "</td>");               
                    ...
                    out.println("<form name=\"f1\" class=\"form\" action=\"ProdutoControlador\" method=\"POST\" onsubmit=\"return validaDados()\">");
    
                        out.println("<!-- Cabeçalho -->");
                        out.println("<header class='form-header'>");
                            out.println("<h1>Remover produto</h1>");
                        out.println("</header>");
                        ...
                        out.println("<div class='input-group'>");
                            ...
                            out.println("<div class='input-box'>");
                                out.println("<label for='code'>Código</label>");
                                out.println("<input id='txtCodigo' type='text' name='txtCodigo' placeholder='Digite o código do produto' required>");
                            out.println("</div>");
                        out.println("</div>");
    
                        out.println("<!-- Botão continuar -->");
                        out.println("<div class='continue-button'>");
                            out.println("<input id=\"idBotao\" type=\"submit\" name=\"b1\" value=\"Remover\">");
                        out.println("</div>");
                    out.println("</form>");
                out.println("</section>");
            out.println("</div>");
